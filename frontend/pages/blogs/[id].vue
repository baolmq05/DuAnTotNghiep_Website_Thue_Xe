<template>
    <section class="bg-gray-50 min-h-screen">
      ...
      <div v-if="!loading && !blogPost" class="max-w-md mx-auto py-24 text-center">
        ...
        <NuxtLink to="/blogs" class="inline-block bg-teal-500 text-white font-semibold px-6 py-2.5 rounded-full hover:bg-teal-600 transition">
          Quay lại trang Blog
        </NuxtLink>
      </div>
      <div v-else-if="!loading && blogPost">
        ...
        <div class="relative h-[400px] md:h-[500px] overflow-hidden">
          <img
            :src="getThumbnailUrl(blogPost.thumbnail)"
            :alt="blogPost.title"
            ...
            <div class="lg:col-span-8 xl:col-span-9 order-2 lg:order-1">
              <article class="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 md:p-10 lg:p-12 blog-content">
                <div 
                  ...
                  class="prose prose-lg max-w-none text-gray-700 leading-relaxed text-justify"
                ></div>
              </article>
            </div>
                ...
                <ul class="space-y-5">
                  <li v-for="post in relatedPosts" :key="post.id">
                    ...
                    >
                      ...
                      />
                      <div>
                        <h4 class="font-semibold text-gray-800 leading-snug group-hover:text-teal-600 transition line-clamp-2">
                          {{ post.title }}
                        </h4>
